...
class EnergyFunctional
{
  ...
  double energy(Wavefunction& rwf, bool compute_hpsi, Wavefunction& dwf,
  ...
  void hpsi(int isp_loc, int ikp_loc, Wavefunction& psi, Wavefunction& hpsi);
  ...
  void update_nl_dk(D3vector deltakick_amp, RTPosition rtp);
