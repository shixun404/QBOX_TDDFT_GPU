...
class ExchangeOperator
{
  ...
  void   rttd_apply_VXC_(double mix, Wavefunction& wf_ref,
    Wavefunction& dwf_ref, Wavefunction& wf, Wavefunction& dwf);
  void   rt_apply_VXC_(int isp_loc, int ikp_loc, double mix, Wavefunction& wf_ref,
    Wavefunction& dwf_ref, Wavefunction& wf, Wavefunction& dwf);
  ...
  void rttd_apply_operator(Wavefunction& wf, Wavefunction& dwf);
  void rt_apply_operator(int isp_loc, int ikp_loc, Wavefunction& wf, Wavefunction& dwf);
